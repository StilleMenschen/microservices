package tech.tystnad.oauth2.server;
...
public class DefaultAuthorizationServerApplicationTests {
    private static final String REDIRECT_URI = "http://127.0.0.1:8086/login/oauth2/code/messaging-client-oidc";
    ...
    public void whenLoginSuccessfulThenDisplayNotFoundError() throws IOException {
        ...
        WebResponse signInResponse = signIn(page, "john", "1234").getWebResponse();
    ...
    public void whenLoginFailsThenDisplayBadCredentials() throws IOException {
        ...
        HtmlPage loginErrorPage = signIn(page, "john", "wrong-password");
    ...
    public void whenLoggingInAndRequestingTokenThenRedirectsToClientApplication() throws IOException {
        ...
        signIn(this.webClient.getPage("/login"), "john", "1234");
